 ...
 */
struct commit *
new_commit (unsigned short major, unsigned long minor, char *comment)
{
...
insert_commit (struct commit *from, struct commit *new)
{
  /* 
 ...
 */
struct commit *
add_minor_commit (struct commit *from, char *comment)
{
 ...
 */
struct commit *
add_major_commit (struct commit *from, char *comment)
{
  /*  Exercice 3 - Question 3 */
  struct commit *new =
 ...
 */
struct commit *
del_commit (struct commit *victim)
{
...
void
extract_major (struct commit *victim)
{
  struct commit *aux, *n;
...
void
extract_minor (struct commit *victim)
{
 ...
 */
void
display_commit (struct commit *c)
{
 ...
 */
void
display_major_commit (struct commit *c)
{
 ...
 */
void
display_history (struct commit *from)
{
  /*  Exercice 3 - Question 4 */
 ...
 */
void
infos (struct commit *from, int major, unsigned long minor)
{
 ...
 */
struct commit *
commitOf (struct version *version)
{
 ...
 */
void
freeHistory (struct commit *from)
{

  struct commit *aux, *n;

  list_for_each_entry_safe (aux, n, &from->history, history) del_commit (aux);
  free (from);
}
